...
class EditHastags extends  ConsumerStatefulWidget {
 
  EditHastags({Key? key,}) : super(key: key);

  @override
  _EditHastagsState createState() => _EditHastagsState();
}

class _EditHastagsState extends ConsumerState<EditHastags> {
...
if(provider.selected.length == 5 ){
    ...
    final updateResponse = await CollectionRepository().updateHastag(preferences.getInt('Userid')!.toInt(),provider.selected );
 ...
 // _searchcontroller.text ='';
  ...
  //getCollectionData();
    ...
    if(updateResponse.result == true){ 
      ...
      print(updateResponse.result);
        print(updateResponse.message);
        print(preferences.getInt('Userid')!.toInt());
