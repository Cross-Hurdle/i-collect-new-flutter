...
class FollowersContainer extends ConsumerStatefulWidget {
  final  id;
  final String? name;
    final String? photo;
  
  const FollowersContainer( {Key? key,required this.id, this.name, this.photo,}) : super(key: key);

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _FollowersContainerState();
}

class _FollowersContainerState extends ConsumerState<FollowersContainer> {
