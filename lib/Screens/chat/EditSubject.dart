...
class EditSubject extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _EditSubjectState();
}

class _EditSubjectState extends ConsumerState<EditSubject> {
TextEditingController _searchcontroller= TextEditingController();
editSubject() async {
    final  messageResponse = await GroupAndChatRepository().getgroupSubjectEditResponse(id:ref.watch(viewgroupprov).groupid!.toInt() ,message:_searchcontroller.text );
  ...
  Widget textField(){
    ...
    _searchcontroller.text=namedata.groupname.toString();
   // TextEditingController _searchcontroller= TextEditingController();
    return Container(
