...
class BuyerAddress extends ConsumerStatefulWidget {
  const BuyerAddress({Key? key}) : super(key: key);

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _BuyerAddressState();
}

class _BuyerAddressState extends ConsumerState<BuyerAddress> {
...
addaddress(String adress_id) async {
 ...
 print('e');
  ...
  Widget build(BuildContext context) {
   // final addressinfo= ref.watch(productupload);
    return Scaffold(
