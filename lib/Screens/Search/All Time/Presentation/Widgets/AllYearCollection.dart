...
class TopCollectionyear extends StatefulWidget {
  final int? id;
 final String? image;
  final String ?title;
  final String? description;
  final int? price;
  const TopCollectionyear({ Key? key,this.description,this.image,this.price,this.title,this.id}) : super(key: key);

  @override
  State<TopCollectionyear> createState() => _TopCollectionyearState();
}

class _TopCollectionyearState extends State<TopCollectionyear> {
@override
