...
//
//     final profilebgModel = profilebgModelFromJson(jsonString);

import 'dart:convert';

ProfilebgModel profilebgModelFromJson(String str) => ProfilebgModel.fromJson(json.decode(str));

String profilebgModelToJson(ProfilebgModel data) => json.encode(data.toJson());

class ProfilebgModel {
    ProfilebgModel({
    ...
    factory ProfilebgModel.fromJson(Map<String, dynamic> json) => ProfilebgModel(
...
//   ]
// });  
//   final response = await Dio().post("http:///i-collekt.jksoftec.com:3001/api/profile/banner-update/${widget.id}",
//  data: formData);
